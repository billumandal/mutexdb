"""
Django settings for mutexdb project.
...
SECRET_KEY = '!7dlsqd2t8hsbj0rvrxb7-of6#dszgq3ck4m)k%1kyi6&v#1t7'
...
WSGI_APPLICATION = 'mutexdb.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'mutexdb.sqlite3'),
    }
}
